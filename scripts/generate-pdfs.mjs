...
const documents = [
  ...
  ['interview-brief.html', 'Russell-Dudek-Baker-Tilly-Interview-Thesis-Brief.pdf'],
...
for (const [source, output] of documents) {
  ...
  html = html.replace(
    '<link rel="stylesheet" href="brand-tokens.css"><link rel="stylesheet" href="styles.css">',
    `<style>${css}</style>`,
  );
